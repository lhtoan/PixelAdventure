...
public class Projecttile : MonoBehaviour
{
    ...
    private Vector2 moveDirection;    // ⭐ Vector thay cho float direction
    ...
    private PlayerAttack attacker;
    public void SetAttacker(PlayerAttack a) => attacker = a;
    ...
    // ===============================================================
    //      SET HƯỚNG MỚI → Vector2 thay cho direction + angle
    // ===============================================================
